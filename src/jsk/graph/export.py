...
Below it, `urs` - the full URS draft the short file replaced - stays until the
builder's legacy branch and `jsk match`'s record_faults stop reading it, and goes with
resolve.py. What follows describes that draft.
