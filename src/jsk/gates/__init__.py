...
One import edge leaves this package - `validate_urs` reaching for `paths` and the
packaged region profiles. Inside, it is
`check_prose` borrowing `validate_urs.numerals` rather than growing a second numeral
